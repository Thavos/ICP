...
QT_MOC_LITERAL(1, 21, 21), // "robotPositionsUpdated"
QT_MOC_LITERAL(2, 43, 0), // ""
QT_MOC_LITERAL(3, 44, 12) // "updateRobots"

    },
    "SimulationController\0robotPositionsUpdated\0"
    "\0updateRobots"
};
...
void SimulationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->robotPositionsUpdated(); break;
        case 1: _t->updateRobots(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimulationController::robotPositionsUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SimulationController::robotPositionsUpdated()
{
